  ...
  const fetchLeaderboardData = async () => {
    try {
      const response = await fetch(
        `https://9kz2rcl6-8000.inc1.devtunnels.ms/get-leaderboard?id=${user?.user_id}` // http://127.0.0.1:8000 "SRM = https://9kz2rcl6-8000.inc1.devtunnels.ms Test = https://9kz2rcl6-8000.inc1.devtunnels.ms"
      );
